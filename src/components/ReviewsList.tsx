    ...
    <Container>   
      <div className=" px-8 py-14">
        <div className="relative flex justify-center mb-8">
          ...
          <span className="absolute deco-text md:deco-text-md lg:deco-text-lg top-[-40px] md:top-[-60px]  left-50 transform translate-50 pointer-events-none text-scalable whitespace-nowrap translate=no" >
              Meine Kunden
            </span>
        </div>
