    ...
    <div className="relative w-full h-[66.6667vh] bg-black overflow-hidden">
      ...
      <div className="relative z-20 flex h-full w-full flex-col justify-end items-start text-left pb-12 px-4 sm:px-6 lg:px-8">
        <div className="relative">
          {/* Decorative Text */}
          <span className="absolute deco-text md:deco-text-md lg:deco-text-lg top-[-35px] md:top-[-50px] lg:top-[-50px] left-50 transform translate-50 pointer-events-none text-scalable whitespace-nowrap">
